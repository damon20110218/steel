...
CREATE TABLE
    ...
    (
        ...
        inventory_date DATE,
        store_in double(20,10) DEFAULT 0.0000,
        store_out double(20,10) DEFAULT 0.0000,
        YEAR INT,
        MONTH VARCHAR(200),
...
CREATE TABLE steel_outbound (out_id int NOT NULL AUTO_INCREMENT, order_no varchar(45), spec_id int, actual_amount double(20,10), out_date date, year int, month int, PRIMARY KEY (out_id)) ENGINE=InnoDB DEFAULT CHARSET=utf8 DEFAULT COLLATE=utf8_general_ci;
